...
urls = {
    ...
    2 : {
        0 : 'https://component-ota-f.coloros.com/update/v3',       # GL
        1 : 'https://component-ota.coloros.com/update/v3',         # CN
        2 : 'https://component-ota-in.coloros.com/update/v3',      # IN
        3 : 'https://component-ota-eu.coloros.com/update/v3'       # EU
    }
}
